...
//    private boolean isSaveFoodEndDay = false;
//
...
//                        throwable -> Log.e(TAG, "Error subscribing to STOMP topic", throwable)
//                );
//        webSocketViewModel.getstompClient().topic("/topic/caculate_calories")
//                .subscribe(
//                        this::pushNotificationCaculateCalories,
//                        throwable -> Log.e(TAG, "Error subscribing to STOMP topic", throwable)
//                );
//        webSocketViewModel.getstompClient().topic("/topic/save_food_end_day")
//                .subscribe(
//                        this::CaCulateFood,
//                        throwable -> Log.e(TAG, "Error subscribing to STOMP topic", throwable)
//                );
...
//            foodConsum.setTotalConsumedWeight("0");
...
//            FoodConsum foodConsum = gson.fromJson(payload, FoodConsum.class);
//            SharedPreferences.Editor editor = prefs.edit();
//            editor.putString(Validation.KEY_FOOD_CONSUMED_END_DAY, gson.toJson(foodConsum));
//            editor.apply();
//            isSaveFoodEndDay = false;
//        }
//    }
//
//
...
//    }
//    private void pushNotificationCaculateCalories(StompMessage stompMessage) {
//        Intent intent = new Intent(this, DashboardActivity.class);
//        intent.putExtra("calories", stompMessage.getPayload());
//        intent.putExtra("navigateToFragment", true);
//        PendingIntent pendingIntent = PendingIntent.getActivity(
//                this,
//                0,
...
//        notificationManager.notify(2, notification);
//    }
//    private void CaCulateFood(StompMessage stompMessage) {
//        isSaveFoodEndDay = true;
//    }
//
